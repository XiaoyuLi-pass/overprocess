...
/**
 * Forked K2 Kotlin Compiler，支持 Jacoco 插桩和三阶段混合编译
 * 版本：2.2.21 (K2)
 */
class ForkedKotlinCompiler(
    ...
    override fun runTest(filePath: String): CompileResult {
        ...
        val execFile = File(jacocoDir, "jacoco-k2.exec")

        val outputDir = File("kotlincK2-classes").apply { mkdirs() }
        ...
        compileLog.appendLine("K2 三阶段编译")
        compileLog.appendLine("=".repeat(60))
    ...
    private fun compileWithThreePhases(
        ...
        if (allFiles.isNotEmpty()) {
            ...
            if (!stubResult.success) {
                ...
                return createResultWithLog("K2", majorError, javaError)
            } else {
